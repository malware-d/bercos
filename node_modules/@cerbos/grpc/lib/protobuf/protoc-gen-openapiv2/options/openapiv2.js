        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 15:
                    ...
                    message.maxLength = longToString(reader.uint64());
                    continue;
                case 16:
                    if (tag !== 128) {
                        break;
                    }
                    message.minLength = longToString(reader.uint64());
                    continue;
                case 17:
                    if (tag !== 138) {
                        break;
                ...
                case 20:
                    ...
                    message.maxItems = longToString(reader.uint64());
                    continue;
                case 21:
                    if (tag !== 168) {
                        break;
                    }
                    message.minItems = longToString(reader.uint64());
                    continue;
                case 22:
                    if (tag !== 176) {
                        break;
                ...
                case 24:
                    ...
                    message.maxProperties = longToString(reader.uint64());
                    continue;
                case 25:
                    if (tag !== 200) {
                        break;
                    }
                    message.minProperties = longToString(reader.uint64());
                    continue;
                case 26:
                    if (tag !== 210) {
                        break;
